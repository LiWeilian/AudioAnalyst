...
namespace FFTWithNAudio
{
    public class MyBiQuadFilter
    {
        ...
        public static MyBiQuadFilter LowPassFilter(float sampleRate, float cutoffFrequency, float q)
        {
            MyBiQuadFilter biQuadFilter = new MyBiQuadFilter();
            biQuadFilter.SetLowPassFilter(sampleRate, cutoffFrequency, q);
            return biQuadFilter;
        }

        public static MyBiQuadFilter HighPassFilter(float sampleRate, float cutoffFrequency, float q)
        {
            MyBiQuadFilter biQuadFilter = new MyBiQuadFilter();
        ...
        public static MyBiQuadFilter BandPassFilterConstantSkirtGain(float sampleRate, float centreFrequency, float q)
        {
            double num = Math.PI * 2.0 * (double)centreFrequency / (double)sampleRate;
            double num2 = Math.Cos(num);
            ...
            return new MyBiQuadFilter(num6, num7, num8, b, num5, b2);
        }

        public static MyBiQuadFilter BandPassFilterConstantPeakGain(float sampleRate, float centreFrequency, float q)
        {
            double num = Math.PI * 2.0 * (double)centreFrequency / (double)sampleRate;
            double num2 = Math.Cos(num);
            double num3 = Math.Sin(num) / (double)(2f * q);
            ...
            return new MyBiQuadFilter(num5, num6, num7, b, num4, b2);
        }

        public static MyBiQuadFilter NotchFilter(float sampleRate, float centreFrequency, float q)
        {
            double num = Math.PI * 2.0 * (double)centreFrequency / (double)sampleRate;
            double num2 = Math.Cos(num);
            double num3 = Math.Sin(num) / (double)(2f * q);
            ...
            return new MyBiQuadFilter(num6, num7, num8, num4, b, num5);
        }

        public static MyBiQuadFilter AllPassFilter(float sampleRate, float centreFrequency, float q)
        {
            double num = Math.PI * 2.0 * (double)centreFrequency / (double)sampleRate;
            double num2 = Math.Cos(num);
            double num3 = Math.Sin(num) / (double)(2f * q);
            ...
            double num6 = 1.0 - num3;
            return new MyBiQuadFilter(num4, num5, num6, b, b2, b3);
        }

        public static MyBiQuadFilter PeakingEQ(float sampleRate, float centreFrequency, float q, float dbGain)
        {
            MyBiQuadFilter biQuadFilter = new MyBiQuadFilter();
        ...
        public static MyBiQuadFilter LowShelf(float sampleRate, float cutoffFrequency, float shelfSlope, float dbGain)
        {
            double num = Math.PI * 2.0 * (double)cutoffFrequency / (double)sampleRate;
            double num2 = Math.Cos(num);
            double num3 = Math.Sin(num);
            ...
            return new MyBiQuadFilter(num7, num8, num9, b, b2, b3);
        }

        public static MyBiQuadFilter HighShelf(float sampleRate, float cutoffFrequency, float shelfSlope, float dbGain)
        {
            double num = Math.PI * 2.0 * (double)cutoffFrequency / (double)sampleRate;
            double num2 = Math.Cos(num);
            double num3 = Math.Sin(num);
        ...
        private MyBiQuadFilter()
        {
            x1 = (x2 = 0f);
            y1 = (y2 = 0f);
        }

        private MyBiQuadFilter(double a0, double a1, double a2, double b0, double b1, double b2)
        {
